...
class BaseDriver extends Protocol {
  ...
  constructor (opts = {}, shouldValidateCaps = true) {
    ...
    // Respect --tmp server arg rather than getting common temp directory path
    this.opts.tmpDir = opts.tmpDir || os.tmpdir();
    if (opts.tmpDir) {
      // Used in appium-support.tempDir module
      process.env.APPIUM_TEMP_DIR = opts.tmpDir;
    }
